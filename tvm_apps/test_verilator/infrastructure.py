...
def compile_hardware(lanes):
    ...
    lib = "D:/workspace/project/nn_compiler/vta-hw/cmake-build-debug-mingw_x86_64/libverilator.dll"
    ...
    if not os.path.isfile(lib):
        ...
        opt_tvm_dir = "TVM_DIR={}".format(tvm_dir)
        cmd = ["make", "--directory", verilator_app_path(), opt_lib_name, opt_lanes, opt_tvm_dir]
