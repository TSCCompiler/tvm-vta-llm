...
#
my_vadd = vta.build(
    s, [A, B, C], tvm.target.Target("ext_dev", host=env.target_host)  # , name="main"
)

# srcs = my_vadd.get_source()
#
# print(srcs)
...
temp = "./"
my_vadd.save(os.path.join(temp, "vadd.o"))

# print(temp.relpath("vadd.o"))

# Send the executable over RPC
# remote.upload("D:/workspace/project/nn_compiler/vta-hw/vadd.so")
remote.upload(os.path.join(temp, "vadd.o"))
######################################################################
# Loading the Module
# ~~~~~~~~~~~~~~~~~~
