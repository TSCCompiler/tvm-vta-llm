...
print("https://github.com/pjreddie/darknet/blob/master/cfg/" + MODEL_NAME + ".cfg" + "?raw=true" + ' to '+MODEL_NAME + ".cfg")
cfg_path = download_testdata(
    "https://github.com/pjreddie/darknet/blob/master/cfg/" + MODEL_NAME + ".cfg" + "?raw=true",
    MODEL_NAME + ".cfg",
    module="darknet",
)
print('download '+"https://pjreddie.com/media/files/" + MODEL_NAME + ".weights" + "?raw=true" + " to "+MODEL_NAME + ".weights")
