...
(* CORE_GENERATION_INFO="store,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.125000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=1567,HLS_SYN_LUT=2283,HLS_VERSION=2019_1}" *)
...
reg   [0:0] icmp_ln552_reg_653;
reg   [0:0] icmp_ln552_reg_653_pp0_iter2_reg;
reg    data_port_blk_n_B;
wire    ap_CS_fsm_state12;
reg   [0:0] icmp_ln552_1_reg_687;
...
reg   [0:0] icmp_ln552_reg_653_pp0_iter1_reg;
wire   [16:0] add_ln552_fu_414_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] empty_9_fu_444_p1;
reg   [0:0] empty_9_reg_667;
wire   [7:0] sub_ln552_2_fu_527_p2;
reg   [7:0] sub_ln552_2_reg_672;
wire   [127:0] lshr_ln552_fu_537_p2;
reg   [127:0] lshr_ln552_reg_677;
wire   [63:0] trunc_ln552_2_fu_557_p1;
reg   [63:0] trunc_ln552_2_reg_682;
wire   [0:0] icmp_ln552_1_fu_561_p2;
wire    ap_CS_fsm_state8;
wire   [15:0] sram_idx_V_1_fu_566_p2;
reg    ap_block_state12;
wire   [31:0] add_ln304_fu_571_p2;
...
wire   [7:0] zext_ln552_3_fu_471_p1;
wire   [0:0] icmp_ln552_2_fu_461_p2;
wire   [7:0] sub_ln552_fu_485_p2;
wire   [7:0] sub_ln552_1_fu_497_p2;
reg   [127:0] tmp_7_fu_475_p4;
wire   [7:0] xor_ln552_fu_491_p2;
wire   [7:0] select_ln552_fu_503_p3;
wire   [7:0] select_ln552_2_fu_519_p3;
wire   [127:0] select_ln552_1_fu_511_p3;
wire   [127:0] zext_ln552_4_fu_533_p1;
wire   [127:0] zext_ln552_5_fu_543_p1;
wire   [127:0] lshr_ln552_2_fu_546_p2;
wire   [127:0] and_ln552_fu_552_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((s2g_dep_queue_V_TREADY == 1'b0) & (s2g_dep_queue_V_1_state == 2'd1)) | ((s2g_dep_queue_V_TREADY == 1'b0) & (s2g_dep_queue_V_1_vld_in == 1'b1) & (s2g_dep_queue_V_1_state == 2'd3)))) begin
            s2g_dep_queue_V_1_state <= 2'd1;
        end else if (((~((s2g_dep_queue_V_1_vld_in == 1'b0) & (s2g_dep_queue_V_1_ack_out == 1'b1)) & ~((s2g_dep_queue_V_TREADY == 1'b0) & (s2g_dep_queue_V_1_vld_in == 1'b1)) & (s2g_dep_queue_V_1_state == 2'd3)) | ((s2g_dep_queue_V_1_ack_out == 1'b1) & (s2g_dep_queue_V_1_state == 2'd1)) | ((s2g_dep_queue_V_1_vld_in == 1'b1) & (s2g_dep_queue_V_1_state == 2'd2)))) begin
...
always @ (posedge ap_clk) begin
    if ((~((data_port_BVALID == 1'b0) & (icmp_ln552_1_reg_687 == 1'd0)) & (1'b1 == ap_CS_fsm_state12))) begin
        dram_idx_V_reg_232 <= add_ln304_fu_571_p2;
    end else if ((~((store_queue_V_V_0_vld_out == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_0_vld_out == 1'b0) & (tmp_2_fu_288_p3 == 1'd1))) & (1'b1 == ap_CS_fsm_state1))) begin
        dram_idx_V_reg_232 <= {{store_queue_V_V_0_data_out[57:26]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((data_port_BVALID == 1'b0) & (icmp_ln552_1_reg_687 == 1'd0)) & (1'b1 == ap_CS_fsm_state12))) begin
        sram_idx_V_0_reg_222 <= sram_idx_V_1_fu_566_p2;
    end else if ((~((store_queue_V_V_0_vld_out == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_0_vld_out == 1'b0) & (tmp_2_fu_288_p3 == 1'd1))) & (1'b1 == ap_CS_fsm_state1))) begin
        sram_idx_V_0_reg_222 <= {{store_queue_V_V_0_data_out[25:10]}};
    end
end

always @ (posedge ap_clk) begin
    if ((~((data_port_BVALID == 1'b0) & (icmp_ln552_1_reg_687 == 1'd0)) & (1'b1 == ap_CS_fsm_state12))) begin
        y_0_reg_242 <= y_reg_628;
    end else if ((~((store_queue_V_V_0_vld_out == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_0_vld_out == 1'b0) & (tmp_2_fu_288_p3 == 1'd1))) & (1'b1 == ap_CS_fsm_state1))) begin
        y_0_reg_242 <= 16'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln547_fu_352_p2 == 1'd0))) begin
        add_ln551_reg_633 <= add_ln551_fu_375_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((store_queue_V_V_0_vld_out == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_0_vld_out == 1'b0) & (tmp_2_fu_288_p3 == 1'd1))) & (1'b1 == ap_CS_fsm_state1))) begin
        and_ln_reg_614[16 : 1] <= and_ln_fu_340_p3[16 : 1];
        p_cast4_reg_576[28 : 0] <= p_cast4_fu_274_p1[28 : 0];
        tmp_V_reg_581 <= store_queue_V_V_0_data_out;
        tmp_reg_599 <= {{store_queue_V_V_0_data_out[79:64]}};
        trunc_ln2_reg_604 <= {{store_queue_V_V_0_data_out[95:80]}};
        zext_ln304_reg_609[15 : 0] <= zext_ln304_fu_336_p1[15 : 0];
        zext_ln552_reg_620[16 : 1] <= zext_ln552_fu_348_p1[16 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln552_fu_409_p2 == 1'd0))) begin
        empty_9_reg_667 <= empty_9_fu_444_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        icmp_ln552_1_reg_687 <= icmp_ln552_1_fu_561_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln552_reg_653 <= icmp_ln552_fu_409_p2;
        icmp_ln552_reg_653_pp0_iter1_reg <= icmp_ln552_reg_653;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        icmp_ln552_reg_653_pp0_iter2_reg <= icmp_ln552_reg_653_pp0_iter1_reg;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln552_reg_653 == 1'd0))) begin
        lshr_ln552_reg_677 <= lshr_ln552_fu_537_p2;
        sub_ln552_2_reg_672[7 : 1] <= sub_ln552_2_fu_527_p2[7 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((data_port_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        shl_ln_reg_648[13 : 1] <= shl_ln_fu_401_p3[13 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln547_fu_352_p2 == 1'd1))) begin
        tmp_6_reg_638 <= tmp_V_reg_581[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln552_reg_653_pp0_iter1_reg == 1'd0))) begin
        trunc_ln552_2_reg_682 <= trunc_ln552_2_fu_557_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2))) begin
        y_reg_628 <= y_fu_357_p2;
    end
end
...
always @ (*) begin
    if ((~((1'b1 == ap_block_state13_io) | (s2g_dep_queue_V_1_state == 2'd1) | ((s2g_dep_queue_V_TREADY == 1'b0) & (s2g_dep_queue_V_1_state == 2'd3))) & (1'b1 == ap_CS_fsm_state13))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((data_port_BVALID == 1'b0) & (icmp_ln552_1_reg_687 == 1'd0)) & (1'b1 == ap_CS_fsm_state12) & (icmp_ln552_1_reg_687 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln552_reg_653_pp0_iter2_reg == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (icmp_ln552_1_reg_687 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln552_reg_653_pp0_iter2_reg == 1'd0))) begin
...
always @ (*) begin
    if ((~((store_queue_V_V_0_vld_out == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_0_vld_out == 1'b0) & (tmp_2_fu_288_p3 == 1'd1))) & (1'b1 == ap_CS_fsm_state1) & (tmp_2_fu_288_p3 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_io) & (ap_predicate_op56_write_state2 == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state13) & (tmp_6_reg_638 == 1'd1)) | ((1'b1 == ap_CS_fsm_state2) & (tmp_6_fu_380_p3 == 1'd1) & (icmp_ln547_fu_352_p2 == 1'd1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln552_fu_409_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln552_fu_409_p2 == 1'd1)) | ((ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln552_1_fu_561_p2 == 1'd1))) begin
...
assign add_ln304_fu_571_p2 = (dram_idx_V_reg_232 + zext_ln304_reg_609);

assign add_ln551_fu_375_p2 = (p_cast4_reg_576 + zext_ln1352_fu_371_p1);

assign add_ln552_1_fu_424_p2 = (shl_ln_reg_648 + trunc_ln552_1_fu_420_p1);

assign add_ln552_fu_414_p2 = (phi_ln552_reg_253 + 17'd1);

assign and_ln552_fu_552_p2 = (lshr_ln552_reg_677 & lshr_ln552_2_fu_546_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((1'b1 == ap_block_state7_io) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((1'b1 == ap_block_state7_io) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

always @ (*) begin
    ap_block_state1 = ((store_queue_V_V_0_vld_out == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_0_vld_out == 1'b0) & (tmp_2_fu_288_p3 == 1'd1)));
end

always @ (*) begin
    ap_block_state12 = ((data_port_BVALID == 1'b0) & (icmp_ln552_1_reg_687 == 1'd0));
end

always @ (*) begin
    ap_block_state13 = ((s2g_dep_queue_V_1_state == 2'd1) | ((s2g_dep_queue_V_TREADY == 1'b0) & (s2g_dep_queue_V_1_state == 2'd3)));
end

always @ (*) begin
    ap_block_state13_io = ((s2g_dep_queue_V_1_ack_in == 1'b0) & (tmp_6_reg_638 == 1'd1));
end

always @ (*) begin
    ap_block_state2_io = ((s2g_dep_queue_V_1_ack_in == 1'b0) & (ap_predicate_op56_write_state2 == 1'b1));
end
...
always @ (*) begin
    ap_block_state7_io = ((data_port_WREADY == 1'b0) & (icmp_ln552_reg_653_pp0_iter2_reg == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op56_write_state2 = ((tmp_6_fu_380_p3 == 1'd1) & (icmp_ln547_fu_352_p2 == 1'd1));
end
...
assign icmp_ln547_fu_352_p2 = ((y_0_reg_242 == tmp_reg_599) ? 1'b1 : 1'b0);

assign icmp_ln552_1_fu_561_p2 = ((and_ln_reg_614 == 17'd0) ? 1'b1 : 1'b0);

assign icmp_ln552_2_fu_461_p2 = ((tmp_8_fu_448_p3 > empty_10_fu_455_p2) ? 1'b1 : 1'b0);

assign icmp_ln552_fu_409_p2 = ((phi_ln552_reg_253 == and_ln_reg_614) ? 1'b1 : 1'b0);

assign lshr_ln552_1_fu_429_p4 = {{add_ln552_1_fu_424_p2[13:1]}};

assign lshr_ln552_2_fu_546_p2 = 128'd340282366920938463463374607431768211455 >> zext_ln552_5_fu_543_p1;

assign lshr_ln552_fu_537_p2 = select_ln552_1_fu_511_p3 >> zext_ln552_4_fu_533_p1;
...
assign select_ln552_1_fu_511_p3 = ((icmp_ln552_2_fu_461_p2[0:0] === 1'b1) ? tmp_7_fu_475_p4 : out_mem_V_Dout_A);

assign select_ln552_2_fu_519_p3 = ((icmp_ln552_2_fu_461_p2[0:0] === 1'b1) ? xor_ln552_fu_491_p2 : zext_ln552_2_fu_467_p1);

assign select_ln552_fu_503_p3 = ((icmp_ln552_2_fu_461_p2[0:0] === 1'b1) ? sub_ln552_fu_485_p2 : sub_ln552_1_fu_497_p2);

assign shl_ln_fu_401_p3 = {{trunc_ln552_fu_397_p1}, {1'd0}};

assign sram_idx_V_1_fu_566_p2 = (trunc_ln2_reg_604 + sram_idx_V_0_reg_222);
...
assign sub_ln552_1_fu_497_p2 = (zext_ln552_3_fu_471_p1 - zext_ln552_2_fu_467_p1);

assign sub_ln552_2_fu_527_p2 = (8'd127 - select_ln552_fu_503_p3);

assign sub_ln552_fu_485_p2 = (zext_ln552_2_fu_467_p1 - zext_ln552_3_fu_471_p1);

assign tmp_1_fu_264_p4 = {{outputs_V[31:3]}};

assign tmp_2_fu_288_p3 = store_queue_V_V_0_data_out[32'd3];

assign tmp_3_fu_278_p4 = {{store_queue_V_V_0_data_out[111:96]}};

assign tmp_6_fu_380_p3 = tmp_V_reg_581[32'd5];

integer ap_tvar_int_0;

always @ (out_mem_V_Dout_A) begin
    for (ap_tvar_int_0 = 128 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 127 - 0) begin
            tmp_7_fu_475_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_7_fu_475_p4[ap_tvar_int_0] = out_mem_V_Dout_A[127 - ap_tvar_int_0];
        end
    end
end

assign tmp_8_fu_448_p3 = {{empty_9_reg_667}, {6'd0}};

assign trunc_ln2_fu_326_p4 = {{store_queue_V_V_0_data_out[95:80]}};

assign trunc_ln552_1_fu_420_p1 = phi_ln552_reg_253[13:0];

assign trunc_ln552_2_fu_557_p1 = and_ln552_fu_552_p2[63:0];

assign trunc_ln552_fu_397_p1 = sram_idx_V_0_reg_222[12:0];

assign xor_ln552_fu_491_p2 = (zext_ln552_2_fu_467_p1 ^ 8'd127);
...
assign zext_ln551_fu_387_p1 = add_ln551_reg_633;

assign zext_ln552_1_fu_439_p1 = lshr_ln552_1_fu_429_p4;

assign zext_ln552_2_fu_467_p1 = tmp_8_fu_448_p3;

assign zext_ln552_3_fu_471_p1 = empty_10_fu_455_p2;

assign zext_ln552_4_fu_533_p1 = select_ln552_2_fu_519_p3;

assign zext_ln552_5_fu_543_p1 = sub_ln552_2_reg_672;

assign zext_ln552_fu_348_p1 = and_ln_fu_340_p3;

always @ (posedge ap_clk) begin
    p_cast4_reg_576[33:29] <= 5'b00000;
    zext_ln304_reg_609[31:16] <= 16'b0000000000000000;
    and_ln_reg_614[0] <= 1'b0;
    zext_ln552_reg_620[0] <= 1'b0;
    zext_ln552_reg_620[31:17] <= 15'b000000000000000;
    shl_ln_reg_648[0] <= 1'b0;
    sub_ln552_2_reg_672[0] <= 1'b0;
end
